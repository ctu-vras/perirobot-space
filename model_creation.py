...
kpt_operator = np.array([[0.084623, 0.099352, 1.721721], [0.023685, 0.121650, 1.716806], [0.084623, 0.099352, 1.721721], 
                            [-0.047704, 0.060070, 1.730057], [0.102995, -0.024719, 1.730057], [-0.023750, 0.219361, 1.514450], 
                            [0.101512, -0.214513, 1.514450], [-0.002789, 0.211081, 1.186939], [0.047996, -0.232904, 1.187355], 
                            [0.196541, 0.268050, 1.151146], [0.305339, -0.108851, 1.118090], [0.087791, 0.106545, 1.039094], 
                            [0.030806, -0.196894, 0.987761], [0.016430, 0.130227, 0.576269], [0.034519, -0.092172, 0.575352], 
...
kpt_02zman = np.array([[0.199843, 0.005302, 1.570330], [0.198014, 0.024809, 1.599651], [0.189723, -0.013900, 1.581241], 
                            ...
                            [0.013305, -0.188459, 1.355872], [0.338953, 0.187511, 1.388029], [-0.245927, -0.239666, 1.201583], 
                            [0.540609, 0.002711, 1.387663], [-0.398084, -0.213514, 0.975665], [-0.017205, 0.108629, 0.904159], 
                            [-0.011567, -0.103755, 0.980481], [-0.293933, 0.131154, 0.366492], [0.259705, -0.079067, 0.942106], 
                            [-0.538413, 0.083971, 0.167305], [0.694411, -0.073306, 0.781873]])


kpt_dummy = np.array([[-0.122258, 0.008754, 1.690146], [-0.119117, -0.035298, 1.743374], [-0.121225, 0.008742, 1.754903], 
...
kpt_waiting = np.array([[0.039667, 0.008902, 1.455261], [0.056552, 0.039692, 1.491407], [-0.008906, 0.001625, 1.504609], 
                            ...
                            [-0.148374, 0.164846, 1.379172], [0.300434, 0.174273, 1.142824], [-0.283716, 0.217087, 1.111333], 
                            [0.314457, 0.118032, 0.887518], [-0.266733, 0.181221, 0.888018], [0.120321, 0.025713, 0.928115], 
                            [-0.123813, 0.070346, 0.997842], [0.106918, -0.173525, 0.573382], [-0.094995, -0.129336, 0.537074], 
...
kpt_what = np.array([[0.044662, -0.212447, 1.476554], [0.115063, -0.222244, 1.522151], [0.034611, -0.222211, 1.522571], 
                            ...
                            [-0.085805, -0.088326, 0.951682], [0.033032, -0.154152, 0.532943], [-0.074166, -0.052112, 0.508021], 
...
kpt_man2 = np.array([[-0.013541, -0.264595, 1.472349], [0.031556, -0.272287, 1.535822], [-0.045260, -0.270554, 1.538319], 
...
if __name__ == "__main__":
    ...
    for i in range(7):
        ...
        np.savetxt(f"scene{i}.csv", kpts, fmt='%1.2f', delimiter=",")
